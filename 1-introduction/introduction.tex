...
\centering \textit{Hello world!} examples
    \begin{columns}
		...
		\begin{block}{Python}
		\vspace{-0.2cm}
			\lstinputlisting[basicstyle=\ttfamily]{code/hello.py}
		\end{block}

		\vspace{-0.2cm}
		\begin{block}{Java}
		\vspace{-0.2cm}
			\lstinputlisting[language=java,basicstyle=\ttfamily\tiny]{code/hello.java}
		\end{block}
 	   \column{.50\textwidth}
		...
		\begin{block}{C}
		\vspace{-0.2cm}
			\lstinputlisting[language=c,basicstyle=\ttfamily\scriptsize]{code/hello.c}
		\end{block}

		\vspace{-0.2cm}
		\begin{block}{C++}
		\vspace{-0.2cm}
			\lstinputlisting[language=c,basicstyle=\ttfamily\scriptsize]{code/hello.cpp}
		\end{block}
	\end{columns}
...
\begin{frame}[fragile]{An informal introduction}{Numbers (II)}
    ...
    \column{.60\textwidth}
		...
		\lstinputlisting[language=Python,basicstyle=\ttfamily\scriptsize]{code/operdemo.py}
		\end{block}
	\end{columns}
...
\begin{frame}[fragile]{Control flow}{Conditions (II)}
	...
	\vspace{-0.2cm}
		\lstinputlisting[language=Python,basicstyle=\ttfamily\scriptsize]{code/if.py}
	\end{block}
...
\begin{frame}{Control flow}{While loop}
	...
	\vspace{-0.2cm}
		\lstinputlisting[language=Python,basicstyle=\ttfamily\scriptsize]{code/fibo.py}
	\end{block}
...
\begin{frame}{Examples}{Example 1: Multiplication table}
	\begin{block}{multi.py}
		\lstinputlisting[language=Python,basicstyle=\ttfamily\scriptsize]{code/multi.py}
	\end{block}
